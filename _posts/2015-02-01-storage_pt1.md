...
summary: Time series data can be difficult to store. It is often generated during a long time periods and can be huge. This can gives us two first requirements: compression and crash recovery.
categories: akumuli
---
...
```
Header|Indirection Vector -->              <-- Data Cunks
+-----+-+-+-+----------------------------------+-+---+--+
|     | | | |                                  | |   |  |
|     | | | |                                  | |   |  |
|     | | | |                                  | |   |  |
